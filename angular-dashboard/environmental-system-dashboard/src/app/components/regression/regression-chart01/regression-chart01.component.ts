...
@Component({
  selector: 'app-regression-chart01',
  templateUrl: './regression-chart01.component.html',
  styleUrls: ['./regression-chart01.component.css']
})
export class RegressionChart01Component implements OnInit {
  ...
  private pointBackgroundColor:string = "#e2481b";
  private pointBorderColor:string = "#fff";
  private lineColor:string = "#e2481b";
  ...
  private GenerateRegressionData(){
    ...
    for (let value of this.data) {
      regressionData.push({x: value.tvoc, y:value.c02});
    }
  ...
  public onPredictC02(value:string){
    this.predictedValue = "";
